      ...
      if (encoder.current && recorder.current) {
        ...
        if (recordState === 'stopped') {
          ...
          if (removeSilence) {
            ...
            logInfo({ out: out.buffer.byteLength })
